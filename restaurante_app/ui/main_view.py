...
class MainView(tk.Frame):
    ...
    def mostrar_productos(self):
        ...
        for producto in self.restaurante_servicio.listar_productos():
            texto_producto = f"{producto.codigo} - {producto.nombre} | {producto.categoria} | {producto.precio}"
            self.crear_fila_informacion(texto_producto)
    ...
    def mostrar_usuarios(self):
        ...
        for usuario in self.restaurante_servicio.listar_usuarios():
            texto = f"{usuario.identificacion} - {usuario.nombre} | usuario: {usuario.usuario} | {usuario.contraseña}"
